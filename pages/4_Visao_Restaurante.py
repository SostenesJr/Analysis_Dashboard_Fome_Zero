...
st.subheader('Temos as seguintes métricas e gráficos dentro da nossa plataforma:')
...
with st.container():
    ...
    with col2:
        ...
        st.metric(':green[Brasileira]: ' + str(df_aux.iloc[0, 1]), value=df_aux.iloc[0, 2] + str(/5.0))
